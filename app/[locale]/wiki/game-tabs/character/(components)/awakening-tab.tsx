  ...
  return (
    <Card className="w-full shadow-md">
      <CardHeader>
        ...
        <CardDescription>Unlock your character's true potential through the awakening system</CardDescription>
      </CardHeader>
      <CardContent className="p-3 sm:p-6">
        <div className="space-y-4 sm:space-y-6">
          <div className="rounded-lg">
            <p className="text-slate-700 text-xs leading-relaxed sm:text-sm dark:text-slate-300">
              Starting at level 600, you will unlock the awakening system which uses{" "}
              <Link
            ...
            <ul className="mt-2 list-disc pl-5 text-slate-700 text-xs sm:text-sm dark:text-slate-300">
              <li>
                Use <span className="font-bold">candles</span> to upgrade individual stats (max level: 600 for each
                skin)
              </li>
              <li>
                Use <span className="font-bold">chalices of darkness</span> to increase stat multipliers (max
                multiplier: x3)
              </li>
              <li>To open awakening of next skin you need to max only stats with <span className="font-bold">candles</span></li>
            </ul>
          </div>
          ...
          <div className="mt-4 rounded-md bg-amber-50 p-2 sm:p-3 dark:bg-amber-950/30">
							<p className="flex items-center font-medium text-amber-800 text-xs sm:text-sm dark:text-amber-400">
								...
								stats from 1-6 may vary in order, only 4 last stats are the same always
							</p>
						</div>
          {isDesktop ? (
              ...
              <Table className="w-full">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Awakening Stats (Maximum Values, with leah items).</TableHead>
                  </TableRow>
                </TableHeader>
                      ...
                      <TableCell>
                        <div className="flex flex-wrap gap-2">
                          {tier.stats.map((stat, statIndex) => (
                            ...
                            >
                              <span className="font-medium">{stat.name}:</span> {stat.value}
                            </div>
                          ))}
                        </div>
                      </TableCell>
