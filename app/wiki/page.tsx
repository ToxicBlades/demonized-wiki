		...
		<div className="container px-4 py-6">
			<div className="mb-8 flex max-w-[980px] flex-col items-start gap-2 md:mb-12">
				...
				<TypographyMuted className="max-w-[90%] text-base md:max-w-[80%] md:text-lg">
					Your comprehensive resource for game information, guides, and
					community knowledge. All content is created and maintained by players
					like you.
				</TypographyMuted>
			</div>
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3">
				<Card className="h-full">
					<CardHeader>
						...
						<CardDescription>
							Comprehensive guides for beginners and veterans
						</CardDescription>
					</CardHeader>
					<CardContent>
						<p className="text-sm md:text-base">
							Find detailed walkthroughs, strategy guides, and tips to help you
							master the game.
						</p>
					</CardContent>
					<CardFooter>
				...
				<Card className="h-full">
					<CardHeader>
						...
						<CardDescription>
							Detailed information on all game elements
						</CardDescription>
					</CardHeader>
					<CardContent>
						<p className="text-sm md:text-base">
							Explore our comprehensive database of characters, items,
							locations, and more.
						</p>
					</CardContent>
					<CardFooter>
				...
				<Card className="h-full sm:col-span-2 lg:col-span-1">
					...
					<CardContent>
						<p className="text-sm md:text-base">
							Join discussions, share your knowledge, and connect with fellow
							players.
						</p>
					</CardContent>
					<CardFooter>
