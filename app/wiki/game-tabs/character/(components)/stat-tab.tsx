				...
				<div className="space-y-6">
					...
					<Tabs defaultValue="beginner" className="w-full">
						...
						<TabsContent value="beginner" className="mt-4 space-y-4">
							<Card>
								<CardHeader className="pb-2">
									<CardTitle className="text-lg">Beginner Build</CardTitle>
									<CardDescription>
								...
								<CardContent>
									<div className="flex flex-wrap gap-2">
										<div className="rounded-full bg-red-100 px-3 py-1 font-medium text-red-800 text-sm dark:bg-red-900 dark:text-red-200">
											STR: 20%
										</div>
						...
						<TabsContent value="midgame" className="mt-4 space-y-4">
							<Card>
								<CardHeader className="pb-2">
									<CardTitle className="text-lg">Mid-Game Build</CardTitle>
						...
						<TabsContent value="endgame" className="mt-4 space-y-4">
							<Card>
								<CardHeader className="pb-2">
									<CardTitle className="text-lg">End-Game Build</CardTitle>
									<CardDescription>
