			...
			<ul>
				...
				<li>
					<p>
						...
						this Agreement) refers to demonized-wiki-olive.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to demonized-wiki-olive, accessible
						from{" "}
						<a
							href="demonized-wiki-olive.vercel.app"
							rel="noreferrer external nofollow noopener"
							target="_blank"
						>
							demonized-wiki-olive.vercel.app
						</a>
					</p>
				</li>
				<li>
